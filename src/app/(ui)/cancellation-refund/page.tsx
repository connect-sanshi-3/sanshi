const CancellationRefundPolicy = () => {
  return (
    <div className="px-6 py-10 md:mx-20 space-y-4 text-sm font-normal">
      <h1 className="text-base font-medium">Cancellation & Refund Policy</h1>
      <p>Last updated on 18-04-2025 10:32:42</p>

      <p>
        SANSHI NETWORK TECH PRIVATE LIMITED believes in helping its customers as
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>
          SANSHI NETWORK TECH PRIVATE LIMITED does not accept cancellation
        ...
        <li>
          ...
          his own end. This should be reported within{" "}
          <span className="font-medium">Only same day</span> days of receipt of
          ...
          <span className="font-medium">Only same day</span> days of receiving
        ...
        <li>
          ...
          Refunds approved by SANSHI NETWORK TECH PRIVATE LIMITED, it’ll take{" "}
          <span className="font-medium">3-5 Days</span> for the refund to be
