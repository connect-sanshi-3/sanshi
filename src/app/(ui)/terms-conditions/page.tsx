const TermsAndConditions = () => {
  return (
    <div className="px-6 py-10 md:mx-20  space-y-4 text-sm font-normal">
      <h1 className="text-base font-medium">Terms & Conditions</h1>
      <p>Last updated on 18-04-2025 10:31:17</p>

      <p>
        These Terms and Conditions, along with privacy policy or other terms
        (“Terms”) constitute a binding agreement by and between SANSHI NETWORK
        TECH PRIVATE LIMITED (“Website Owner” or “we” or “us” or “our”) and you
      ...
      <ul className="list-disc list-inside space-y-2">
        ...
        <li>
          ...
          subject to the exclusive jurisdiction of the courts in HAYATHNAGAR,
          TELANGANA.
        </li>
        <li>
